...
One specificity of gol is that is is Turing-complete, horever this is only true if the grid size is truly infinite (or, more realistically, if the grid grows as needed).
...
Sadly, I have for now only implemeted the expansion on the left and right side of the grid.
